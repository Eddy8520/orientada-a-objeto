...
///calcule la sumatoria tfNum2Y3   
double n1=Double.parseDouble(tfNum2.getText());
double n2=Double.parseDouble(tfNum3.getText());
double resp2=por.sumatoria2(n1,n2);
